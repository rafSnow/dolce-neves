    ...
    >
      <div className="max-w-md mx-auto px-4 text-center">
        ...
        <p className="font-body text-dolce-marrom/60 mb-8">
          Nao conseguimos carregar o cardapio. Por favor, tente novamente em
          alguns instantes.
        </p>
        <button
          onClick={reset}
          className="inline-flex items-center justify-center px-8 py-3 bg-dolce-rosa text-white font-body font-semibold rounded-full hover:bg-dolce-rosa/90 transition-all duration-300 shadow-md hover:shadow-lg"
        >
          Tentar novamente
        </button>
      </div>
